            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.editUserSubmit', $userId) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="mobile" type="mobile" class="form-control" name="mobile" value="<?php echo $mobile ?>" required>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="address" class="form-control" name="address" value="<?php echo $address ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" value = "<?php echo $password ?>" required>
                                </div>
                            </div>
